...
from transition_parse import PartialParse, get_sentence, minibatch_parse
...
@main.command()
def transition_c():
    '''Run basic tests for question transition c: complete, parse_step, get_nrightmost, get_nleftmost.'''
    click.echo('='*80 + '\nRunning Transition(c) tests.\n' + '='*80)
...
@main.command()
def transition_d():
    '''Run basic tests for question transition d: complete'''
    click.echo('='*80 + '\nRunning Transition(d) tests.\n' + '='*80)
    test_minibatch_parse()

@main.command()
def transition_e():
    '''Run basic tests for question transition e: oracle.'''
    click.echo('='*80 + '\nRunning Transition(e) tests.\n' + '='*80)
    test_oracle()
